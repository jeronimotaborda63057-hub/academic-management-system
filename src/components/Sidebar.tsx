...
const menuItems = [
    {
        ...
        icon: (
            <svg
                ...
                viewBox="0 0 24 24"
            >
                <path d="M7 2V4H17V2H19V4H22V22H2V4H5V2H7ZM20 10H4V20H20V10ZM6 12H11V17H6V12Z" />
            </svg>
        ),
    },
...

    {
        ...
        icon: (
            <svg
                ...
                viewBox="0 0 24 24"
            >
                <path d="M3 3H21V21H3V3ZM5 5V10H10V5H5ZM12 5V10H19V5H12ZM5 12V19H10V12H5ZM12 12V19H19V12H12Z" />
            </svg>
        ),
    },
