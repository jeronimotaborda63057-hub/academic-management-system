                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            className="h-10 rounded-lg border border-stroke dark:border-strokedark bg-transparent px-3 text-sm text-black dark:text-white outline-none focus:border-primary dark:focus:border-primary transition-colors"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            className="h-10 rounded-lg border border-stroke dark:border-strokedark bg-transparent px-3 text-sm text-black dark:text-white outline-none focus:border-primary dark:focus:border-primary transition-colors"
                        />
                        <span className="text-xs text-body dark:text-bodydark2 text-right cursor-pointer hover:text-black dark:hover:text-white transition-colors">
                    ...
                    <button
                        type="submit"
                        className="h-10 rounded-lg bg-black dark:bg-primary text-white text-sm font-medium hover:opacity-90 transition-opacity mt-1"
                    >
                        Iniciar sesión
                    </button>
                </form>
                ...
                <div className="flex flex-col gap-2">
                    {[
                        ...
                        <button
                            key={label}
                            onClick={onClick}
                            className="flex items-center justify-center gap-2 h-10 rounded-lg border border-stroke dark:border-strokedark bg-transparent text-sm text-black dark:text-white hover:bg-gray-50 dark:hover:bg-meta-4 transition-colors"
                        >
                            {icon}
                            {label}
                        </button>
